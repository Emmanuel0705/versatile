...
(function ($) {
  ...
  $(".banner-slider-active").slick({
    ...
    adaptiveHeight: true,
    prevArrow:
      '<button class="cr-slick-arrow cr-slick-prev"><i class="fa fa-angle-left"></i></button>',
    nextArrow:
      '<button class="cr-slick-arrow cr-slick-next"><i class="fa fa-angle-right"></i></button>',
  });
